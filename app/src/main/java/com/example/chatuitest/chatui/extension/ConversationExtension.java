...
import com.example.chatuitest.chatui.ext.ConversationExtManager;
import com.example.chatuitest.chatui.ext.ConversationExtPageView;
import com.example.chatuitest.chatui.ext.ConversationExtPagerAdapter;
...
public class ConversationExtension {
    ...
    public void bind(Conversation conversation) {
        ...
        for (int i = 0; i < exts.size(); i++) {
            exts.get(i).onBind(activity, conversation, this, i);
        }
    }
    ...
    private void setupExtViewPager(ViewPager viewPager) {
        ...
        viewPager.setAdapter(new ConversationExtPagerAdapter(exts, new ConversationExtPageView.OnExtViewClickListener() {
            @Override
